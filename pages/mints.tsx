...
import { useTrendingMints } from '../hooks/useTrendingMints';
...
const Mints: NextPage = () => {
  ...
  const { trendingArr } = useTrendingMints(
    ...
    <>
      ...
      <div className='flex flex-col justify-center items-center p-24'>
        <div className='flex items-center gap-24 mb-12'>
          <span className='text-3xl font-medium'>Most Active Mints</span>
        ...
        {/* trending table */}
        <MintingContainer trendingArr={trendingArr} />
      </div>
    </>
  );
};
